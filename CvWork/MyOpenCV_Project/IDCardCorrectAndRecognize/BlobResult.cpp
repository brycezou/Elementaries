...
- AUTOR: Ricard Borràs
- DATA DE CREACI? 25-05-2005.
- NOTA: per la implementaci? els blobs del paràmetre es posen en ordre invers
- MODIFICACI? Data. Autor. Descripci?
*/
/**
- FUNCTION: + operator
...
- PARÀMETRES:
	...
	- LowLimit:  valor numèric per a la comparaci?(Condition) de la mesura (FilterType)
	- HighLimit: valor numèric per a la comparaci?(Condition) de la mesura (FilterType)
				 (només t?sentit per a aquelles condicions que tenen dos valors 
...
/**
- FUNCI? RaiseError
- FUNCIONALITAT: Funci?per a notificar errors al l'usuari (en debug) i llença
			   les excepcions
- PARÀMETRES:
	- errorCode: codi d'error
- RESULTAT: 
	- Ensenya un missatge a l'usuari (en debug) i llença una excepci?
- RESTRICCIONS:
- AUTOR: Ricard Borràs Navarra
- DATA DE CREACI? 25-05-2005.
- MODIFICACI? Data. Autor. Descripci?
